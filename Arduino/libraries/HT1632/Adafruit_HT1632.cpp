...
Adafruit_HT1632LEDMatrix::Adafruit_HT1632LEDMatrix(uint8_t data, uint8_t wr,
                                                   uint8_t cs1)
    : Adafruit_GFX(30, 7), matrices(NULL), matrixNum(0) {
...
Adafruit_HT1632LEDMatrix::Adafruit_HT1632LEDMatrix(uint8_t data, uint8_t wr,
    ...
    : Adafruit_GFX(105, 7), matrices(NULL), matrixNum(0) {
...
void Adafruit_HT1632LEDMatrix::drawPixel(int16_t x, int16_t y, uint16_t color) {
  ...
  uint8_t m = x / (120 / matrixNum); // Which matrix controller is pixel on?
  x %= 30;            // Which column in matrix?
